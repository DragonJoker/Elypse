...
namespace GuiCommon
{
	...
	{
		m_gradientTopStartColour = GuiCommon::InactiveTextColour;
		m_gradientTopEndColour = GuiCommon::BorderColour;
		m_gradientBottomStartColour = GuiCommon::PanelBackgroundColour;
		m_gradientBottomEndColour = GuiCommon::InactiveTabColour;
		m_pressedColourTop = GuiCommon::InactiveTabColour;
		m_pressedColourBottom = GuiCommon::PanelBackgroundColour;
