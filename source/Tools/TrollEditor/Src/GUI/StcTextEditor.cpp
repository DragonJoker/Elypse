...
BEGIN_TROLL_GUI_NAMESPACE
{
	...
	wxStcTextEditor::wxStcTextEditor( TROLL_PROJECT_NAMESPACE::File * p_file, StcContext const & p_context, wxWindow * p_pParent, wxWindowID p_id, wxPoint const & p_ptPos, wxSize const & p_size, long p_lStyle )
