...
BEGIN_TROLL_PROJECT_3D_NAMESPACE
{
	...
	{
	public:
		TrollSceneNode( const wxString & p_name, const wxString & p_fileName, const Vector3 & p_position = Vector3::ZERO, const Quaternion & p_orientation = Quaternion::IDENTITY, const Vector3 & p_scale = Vector3( 1, 1, 1 ) );
