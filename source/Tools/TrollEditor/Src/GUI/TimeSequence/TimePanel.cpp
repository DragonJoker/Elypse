...
BEGIN_TROLL_GUI_TIME_NAMESPACE
{
	...
	TimePanel::TimePanel( wxWindow * p_parent, wxWindowID p_id, const wxPoint & p_position, const wxSize & p_size )
	...
	void TimePanel::UpdateTick( int p_left, bool p_updateSequence )
	{
		...
		if ( p_updateSequence )
		{
			...
			GUI::MainFrame::GetInstance()->GetTimelineEditor()->UpdateSequences( l_tmpTime - m_currentTime );
