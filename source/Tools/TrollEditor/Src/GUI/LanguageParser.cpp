...
BEGIN_TROLL_GUI_NAMESPACE
{
	...
	IMPLEMENT_ATTRIBUTE_PARSER( Language_End )
	{
		ATTRIBUTE_END_POP();
	}
	...
	IMPLEMENT_ATTRIBUTE_PARSER( Style_End )
	{
		ATTRIBUTE_END_POP();
	}
	...
	IMPLEMENT_ATTRIBUTE_PARSER( Section_Style )
	{
		LanguageFileContextPtr l_pContext = std::static_pointer_cast< LanguageFileContext >( p_pContext );
	...
	IMPLEMENT_ATTRIBUTE_PARSER( List_End )
	{
		ATTRIBUTE_END_POP();
	}
}
