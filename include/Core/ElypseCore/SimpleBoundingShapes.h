...
namespace Elypse
{
	namespace Physics
	{
		...
		public:
			...
			{
				m_plane = p_plane;
				m_geom = dCreatePlane( nullptr, m_plane.normal.x, m_plane.normal.y, m_plane.normal.z, -m_plane.d );
				_register();
			}
		...
		public:
			...
			{
				m_extends = p_extends;
				m_geom = dCreateBox( nullptr, p_extends.x, p_extends.y, p_extends.z );
		...
		public:
			...
			{
				m_radius = p_radius;
				m_geom = dCreateSphere( nullptr, p_radius );
				_register();
			}
