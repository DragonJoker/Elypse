...
namespace Elypse
{
	namespace Script
	{
		...
		protected:
			String _hash( VariableBaseType p_type, VariableType * p_subType1 = nullptr, VariableType * p_subType2 = nullptr );

			VariableType * _add( VariableBaseType p_type, VariableType * p_subType1 = nullptr, VariableType * p_subType2 = nullptr, String const & p_hash = EMPTY_STRING );
		...
		public:
			...
			static inline VariableType * Get( VariableBaseType p_type, VariableType * p_subType1 = nullptr, VariableType * p_subType2 = nullptr )
			{
		...
		public:
			VariableType( VariableBaseType p_mainType, VariableType * p_subType1, VariableType * p_subType2 )
				...
				, m_struct( nullptr )
			{
				if ( p_subType1 != nullptr )
				{
					m_subTypes.push_back( p_subType1 );
				}

				if ( p_subType2 != nullptr )
				{
