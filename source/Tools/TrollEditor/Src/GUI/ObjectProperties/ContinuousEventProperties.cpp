...
BEGIN_TROLL_GUI_PROPERTIES_NAMESPACE
{
	...
	ContinuousEventProperties::ContinuousEventProperties( TROLL_PROJECT_TEMPORAL_NAMESPACE::TrollContinuousEvent & p_event, wxWindow * parent, const wxPoint & pos, const wxSize & size, long style )
	...
	void ContinuousEventProperties::UpdateProperties()
	{
		...
		for ( auto && l_it : l_tmp )
		{
			l_actions.push_back( make_wxString( l_it ) );
		}
