...
BEGIN_TROLL_GUI_PROPERTIES_NAMESPACE
{
	...
	{
	public:
		VideoObjectProperties( TROLL_PROJECT_MEDIA_NAMESPACE::TrollVideoObject * p_videoObject, wxWindow * parent, const wxPoint & pos = wxDefaultPosition, const wxSize & size = wxDefaultSize, long style = wxBORDER_NONE );
	...
	private:
		TROLL_PROJECT_MEDIA_NAMESPACE::TrollVideoObject * m_videoObject;
