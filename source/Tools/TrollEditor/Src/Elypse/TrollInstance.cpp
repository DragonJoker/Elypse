...
{
	TrollInstance::TrollInstance( const String & p_installPath , ElypsePlugin * p_plugin )
	...
	void TrollInstance::CreateScene()
	{
		...
		TROLL_PROJECT_3D_NAMESPACE::TrollSceneNode * l_rootNode = GUI::MainFrame::GetInstance()->GetCurrentProject()->GetMainScene()->AddSceneNode( wxT( "root node" ), wxT( "" ) );
