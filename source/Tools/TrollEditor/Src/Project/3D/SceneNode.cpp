...
{
	TrollSceneNode::TrollSceneNode( const wxString & p_name, const wxString & p_fileName, const Vector3 & p_position, const Quaternion & p_orientation, const Vector3 & p_scale )
	...
	int TrollSceneNode::BuildPanel( wxWindow * p_parent, int p_width )
	{
		...
		m_propertiesPanel = new TROLL_GUI_PROPERTIES_NAMESPACE::SceneNodeProperties( this, p_parent, wxPoint( 0, 0 ), l_returnSize );
