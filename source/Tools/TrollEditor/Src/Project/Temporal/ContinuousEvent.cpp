...
BEGIN_TROLL_PROJECT_TEMPORAL_NAMESPACE
{
	int TrollKeyFrame::BuildPanel( wxWindow * p_parent, int p_width )
	{
		...
		m_propertiesPanel = new Properties::KeyFrameProperties( this, p_parent, wxPoint( 0, 0 ), wxSize( p_width, l_height ) );
		return l_height;
	}
	...
	TrollContinuousEvent::TrollContinuousEvent( TrollSequence * p_sequence, BaseContinuousEvent * p_event, const wxString & p_name, const wxString & p_fileName )
	...
	int TrollContinuousEvent::BuildPanel( wxWindow * p_parent, int p_width )
	{
		...
		m_propertiesPanel = new Properties::ContinuousEventProperties( *this, p_parent, wxPoint( 0, 0 ), wxSize( p_width, l_height ) );
		return l_height;
	}
