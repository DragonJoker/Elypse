...
#define GENLIB_INIT_SINGLETON( p_name ) //template <> p_name * General::Theory::Singleton <p_name> ::sm_singleton = nullptr
...
#define GENLIB_INIT_SINGLETON_FOR_DLL( p_name) p_name * p_name::sm_singleton = nullptr; p_name * p_name::GetSingletonPtr()	{ return sm_singleton; } p_name & p_name::GetSingleton()	{ return *sm_singleton; }
