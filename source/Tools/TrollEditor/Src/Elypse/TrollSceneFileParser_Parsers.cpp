...
namespace Troll
{
	namespace ElypseRW
	{
		...
		ProjectComponents::Object * g_currentObject = NULL;
		ProjectComponents::Objects2D::TrollOverlay * g_currentOverlay = NULL;
		std::shared_ptr< ProjectComponents::Temporal::TrollSequence > g_currentSequence = NULL;
		ProjectComponents::Temporal::TrollContinuousEvent * g_continuousEvent = NULL;
		ProjectComponents::Temporal::TrollAnimationGroup * g_currentAnimationGroup = NULL;
		ProjectComponents::Temporal::TrollAnimatedObject * g_currentAnimatedObject = NULL;
		...
		DEFINE_SCENE_FILE_TROLL_PARSER( TrollParser_RootOverlay )
		{
			if ( g_fileName != wxT( "SceneEditor.emscene" ) && g_fileName != wxT( "OverlayEditor.emscene" ) && !wxGetApp().GetMainFrame()->IsTestingScene() )
			{
				...
				if ( wxGetApp().GetMainFrame()->IsEditingOverlays() && g_currentOverlay != NULL )
				{
