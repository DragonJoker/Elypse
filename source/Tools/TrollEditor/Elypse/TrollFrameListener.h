...
namespace Troll::ElypseRW
{
	class TrollFrameListener
		: public ElypseFrameListener
	{
	public:
		TrollFrameListener( TrollInstance & p_instance
			, RenderWindow * p_window
			, String const & p_baseURL
			, String const & p_installPath
			, String const & p_appStringIndex );
		TrollFrameListener( TrollInstance & p_instance
			, ElypseFrameListener * p_ofl
			, RenderWindow * p_window
			, String const & p_instanceNum );
