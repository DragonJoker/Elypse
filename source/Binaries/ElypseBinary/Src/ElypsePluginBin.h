...
#include "../EMuseCore/Main/EMusePlugin.h"
...
{ namespace Binary
{
	...
	public:
		virtual bool OpenURL( const String & p_url, bool p_newWindow, bool p_usePostMethod) { return true; }
		...
		virtual bool ExecuteJavascript( const String & p_functionName) { return true; };
	public:
		inline void SetHandle( wxWindow * p_handle)					{ m_handle = p_handle; }
	};
}
}
