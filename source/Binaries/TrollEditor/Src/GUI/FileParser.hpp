...
namespace Troll
{
	namespace GUI
	{
		...
		*/
		 ...
		 */
		typedef bool ( ParserFunction )( Troll::GUI::FileParser * p_pParser, wxString & p_strParams, Troll::GUI::FileParserContextPtr p_pContext );
...
#	define PARSE_ERROR( p_strError) Troll::GUI::FileParser::ParseError( (p_strError), (p_pContext) )
...
#	define PARSE_WARNING( p_strWarning) Troll::GUI::FileParser::ParseWarning( (p_strWarning), (p_pContext) )
		/*!
		\author		Sylvain DOREMUS
		\version	0.6.1.0
		\date		19/10/2011
