...
namespace Elypse
{
	namespace Script
	{
		...
		protected:
			...
			ScriptNode * _compileFuncParams( ScriptBlockArray & p_blockArray, Function * p_functionNode, ScriptNode * p_node = nullptr );
		...
		protected:
			...
			{
				return m_currentUserFunction != nullptr;
			}
			inline bool _isInStructDecla()const
			{
				return m_currentStructure != nullptr;
			}
