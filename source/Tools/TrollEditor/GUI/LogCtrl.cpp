...
namespace Troll::GUI
{
	...
	LogFile::LogFile( wxString const & p_fileName )
		: wxLog{}
		, m_fileName{ p_fileName }
	{
		std::ofstream l_out{ m_fileName.c_str().AsChar() };

		if ( l_out )
		{
			l_out << "Started logging\n";
		}
	}

	void LogFile::DoLogText( const wxString & msg )
	{
		std::ofstream l_out{ m_fileName.c_str().AsChar(), std::ios_base::app };
